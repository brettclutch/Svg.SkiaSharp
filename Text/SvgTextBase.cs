...
namespace Svg
{
    public abstract class SvgTextBase : SvgVisualElement
    {
        ...
        {
            get { return (this.Attributes["fill"] == null) ? new SvgColorServer(Colors.Black) : (SvgPaintServer)this.Attributes["fill"]; }
        ...
        protected override void Render(ISvgRenderer renderer)
        {
            if ((this.Path(renderer) != null) && this.Visible && this.Displayable)
            {
                ...
                if (_TextRenderer != null)
                    _TextRenderer.Render(this, renderer);
                else
                {
                    RenderFill(renderer);
        ...
        //    path.AddString(c.ToString(), font.FontFamily, (int)font.Style, font.Size, new Point(0, 0), FontFamilyProvider.GenericTypographic);
        //    return path.GetBounds();
        //}
