...
namespace Svg
{
    public partial class SvgElement
    {
        ...
        internal IFontDefn GetFont(ISvgRenderer renderer)
        {
            ...
            if (sFaces == null)
            {
                var fontStyle = Svg.SkiaSharp.FontStyle.Regular;
                ...
                switch (this.FontWeight)
                {
                    ...
                    case SvgFontWeight.W900:
                        fontStyle |= Svg.SkiaSharp.FontStyle.Bold;
                        break;
                }
                ...
                switch (this.FontStyle)
                {
                    ...
                    case SvgFontStyle.Oblique:
                        fontStyle |= Svg.SkiaSharp.FontStyle.Italic;
                        break;
                }
                ...
                switch (this.TextDecoration)
                {
                    case SvgTextDecoration.LineThrough:
                        fontStyle |= Svg.SkiaSharp.FontStyle.Strikeout;
                        break;
                    case SvgTextDecoration.Underline:
                        fontStyle |= Svg.SkiaSharp.FontStyle.Underline;
                        break;
                }

                //TODO: Brett should this be GenericTypography?
                //var ff = family as FontFamily;
                var ff = FontFamilyProvider.GenericSerif;

                //TODO: Need to handle case where font style not available... (Shouldn't be) 
                ...
                // Get the font-family
                return new GdiFontDefn(new Font((FontFamily)ff, fontSize, fontStyle, GraphicsUnit.Pixel));
            }
            else
            {
        ...
        public static object ValidateFontFamily(string fontFamilyList, SvgDocument doc)
        {
            ...
            var families = Svg.SkiaSharp.FontFamilyProvider.Families;
            ...
            foreach (var f in fontParts)
            {
                ...
                //TODO: This appears to be code to try from another PrivateFont area. Need to check into that. 
                ...
                {
                    case "serif":
                        return FontFamilyProvider.GenericSerif;
                    case "sans-serif":
                        return FontFamilyProvider.GenericSansSerif;
                    case "monospace":
                        return FontFamilyProvider.GenericMonospace;
                }
            }
