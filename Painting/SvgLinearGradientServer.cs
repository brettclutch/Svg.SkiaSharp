    ...
    public sealed class SvgLinearGradientServer : SvgGradientServer
    {
        ...
        public override IBrush GetBrush(SvgVisualElement renderingElement, ISvgRenderer renderer, float opacity, bool forStroke = false)
        {
            ...
            if (this.Stops.Count == 1) 
            {
                ...
                Color color = new Color(alpha, stopColor);
            ...
            try
            {
                ...
                var result = new LinearGradientBrush(effectiveStart, effectiveEnd, Colors.Transparent, Colors.Transparent)
                {
        ...
        private sealed class LineF
        {
            ...
            /// TODO: Removed ? not sure if it will break anything
