...
namespace Svg.FilterEffects
{
    public class ImageBuffer : IDictionary<string, Bitmap>
    {
        ...
        private Bitmap CreateSourceAlpha()
        {
            ...
            using (var g = new Graphics((Bitmap)sourceAlpha))
            {
                g.DrawImage(source, new RectangleF(0, 0, source.Width, source.Height), 0, 0, source.Width, source.Height, GraphicsUnit.Pixel, attributes);
                g.Save();
            }
